...
class FileListItemWidget(QWidget):
    def __init__(self, file_name: str, file_path: str, parent=None):
        ...
        self.setObjectName("FileListItemWidget")
    ...
    def setup_ui(self):
        ...
        self.main_layout.addWidget(self.content_widget, alignment=Qt.AlignmentFlag.AlignLeft)
        ...
        self.delete_push_button.setObjectName("DeletePushButton")
        self.delete_push_button.setIcon(QIcon(":/assets/trash.svg"))
        self.main_layout.addWidget(
            self.delete_push_button, alignment=Qt.AlignmentFlag.AlignLeft
        )
